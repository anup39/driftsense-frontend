...
import SheldBlack from "./images/shield-black.svg";
  ...
  return (
   <>
        <table className="text-xs tdc:text-white" >
            <tbody>
                <tr>
                    <td><img src={Sheld} alt="" className="hidden tdc:block"></img><img src={SheldBlack} alt="" className="block tdc:hidden"></img></td>
